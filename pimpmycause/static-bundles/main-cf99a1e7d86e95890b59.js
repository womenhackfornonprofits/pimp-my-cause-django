...
function renderTeamMember(element, teamMemberData) {
    ...
    const teamMemberTemplate = `
        <div class="team__individual-wrapper">
            <div class="team__individual-image" src=${teamMemberData.imageUrl}/></div>
            <img alt="{{ person.name}} {{person.surname}} Image" class="team__individual-image" src="${teamMemberData.imageUrl}"/>
...
/***/ })
/******/ ]);
//# sourceMappingURL=main-cf99a1e7d86e95890b59.js.map